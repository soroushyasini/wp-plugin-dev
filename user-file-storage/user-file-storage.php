...
class UserFileStorage {
    ...
    public function handle_file_upload() {
        ...
        if (move_uploaded_file($file['tmp_name'], $file_path)) {
            // Save to database
            $file_id = $this->save_file_to_db($user_id, $file['name'], $file_path, $file['size'], $file['type']);
            ...
            if ($file_id) {
                ...
                unlink($file_path); // Remove file if DB save failed
...
private function validate_file($file) {
     ...
     */
    private function save_file_to_db($user_id, $filename, $filepath, $filesize, $mimetype) {
        global $wpdb;
